...
public class DataLayer extends JPanel
{
     ...
     */
    public DataLayer(WorldWindow wwd)
    {
     ...
     */
    public DataLayer(WorldWindow wwd, Dimension size)
    {
    ...
    protected void makePanel(WorldWindow wwd, Dimension size)
    {
        ...
        westPanel.setBorder(
            new CompoundBorder(BorderFactory.createEmptyBorder(9, 9, 9, 9), new TitledBorder("Data Layers")));
    ...
    protected void fill(WorldWindow wwd)
    {
        ...
        for (Layer layer : StartUpGUI.dataLayer)
        {
