...
public class AnalyticMeshDemo extends ApplicationTemplate{
    protected static final String DATA_PATH = "/home/vishal/worldwind-2.0.0/src/gov/nasa/worldwindx/examples/data/wa-precip-24hmam-5km.tif";
    ...
    {
    	Configuration.setValue(AVKey.INITIAL_LATITUDE, 25);
		Configuration.setValue(AVKey.INITIAL_LONGITUDE, -90);
		Configuration.setValue(AVKey.INITIAL_ALTITUDE, 6550000);
